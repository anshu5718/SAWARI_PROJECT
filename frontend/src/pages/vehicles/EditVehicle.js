...
function EditVehicle() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        ...
        const response = await fetch(`https://bisaka.pythonanywhere.com/api/edit-vehicle/${id}/`, {
        method: 'PATCH',
        credentials: 'include',
        headers: {
        ...
        if (formData.vehicle_image) {
            ...
            const imgResponse = await fetch(`https://bisaka.pythonanywhere.com/api/edit-vehicle-image/${id}/`, {
                method: 'POST',
                credentials: 'include',
